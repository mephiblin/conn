    ...
    public static class MapGenV2DeferredVerification
    {
        ...
        public static void RunPersistenceBatch()
        {
            ...
            try
            {
                ...
                Require(draft.Accepted, "Persisted draft lost saved state.");
                Require(draft.IsAcceptedSignatureCurrent, "Persisted draft saved signature is stale.");
        ...
        private static void VerifyStyleSwap(VerificationLog log, VerificationContext context)
        {
            ...
            log.Pass("Multiple style sets verified on the same saved draft without changing layout signature.");
        }
