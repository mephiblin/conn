        ...
        public static MapGenValidationReport ValidateExistingOutput(MapGenMockupDraftAsset draft, GameObject root)
        {
            ...
            if (root == null)
            {
                validation.Add(new MapGenIssue(
                    ...
                    "Materialize the saved draft or find the previous root.",
            ...
            AddMismatchIssue(
                ...
                "Materialized output was produced from a different saved draft.",
                "Save the current draft if needed, then rematerialize the scene output.",
            ...
            if (staleModuleMarkers > 0)
            {
                validation.Add(new MapGenIssue(
                    ...
                    $"{staleModuleMarkers} materialized module markers do not match the current saved draft or module set.",
