...
| P2 전투/스킬/주사위 | 45-55% | 최소 규칙은 있으나 전투 깊이와 적 데이터가 부족 |
| P3 장비/인벤토리/상점 | 45-55% | 구매/판매/장착은 가능하나 슬롯/재고/UX가 임시 |
...
1. 전투 데이터 분리
   ...
   - `MonsterDefinition`
   - enemy HP/공격력/보상 데이터
   - 퀘스트 target monster와 encounter 연결
