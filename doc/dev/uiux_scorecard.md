...
| 상점 상호작용 | 8.0 | 9.5 | 구매/판매/비교/상세 패널이 있고, 호버뿐 아니라 클릭으로도 상세 대상이 고정됨. 선택된 카드의 배경/테두리/상태 배지가 분리되어 현재 상품과 실행 가능 여부가 더 분명해짐. 상점 헤더 문구와 귀환 정산 요약도 플레이 흐름 중심으로 압축됨. | 구매 확인 흐름과 최종 상점 아이콘/카드 아트가 들어가면 10점. |
